...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  53.13        // (Hz) The default dominant resonant frequency on the X axis.
...
//#if HAS_BED_PROBE && (defined(HAS_MARLINUI_MENU) || defined(HAS_TFT_LVGL_UI) || defined(TFT_COLOR_UI))
